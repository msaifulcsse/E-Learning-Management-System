...
<div class="container">
    <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
            <br><br>
               <h2 align="center">Search Result || All Course</h2>
               <hr>
            </div>
            <hr>
            <div class="col-sm-12">
      ...
      <center>
                    ...
                    if($_SERVER["REQUEST_METHOD"] == "POST")
                      {
                        $course_name = $_REQUEST["searchInput"];                                                    
                        $sql = "SELECT * FROM publish_course WHERE course_name LIKE '$course_name%' OR subsub_category LIKE '$course_name%' OR sub_category LIKE '$course_name%';";
