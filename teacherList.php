...
<div class="container">
  	<div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
            <br><br>
               <h2 align="center">All Teacher</h2>
               <hr>
            </div>
            <hr>
            <div class="col-sm-12">
                    ...
                    <?php
                        while($row = mysql_fetch_array($result)) {
                         ...
                         <tbody>
                           ...
                           <td>
                             <?php echo $row['idcreate_date']?>
                           </td>
                           <td onclick="document.location = 'teacher.php?id=<?php echo urlencode($tid);?>'" style="background-color: coral; color: white; font-size: 15px;">Details</td>
                          </tr>
                          </tbody>                
                    <?php
                    }
