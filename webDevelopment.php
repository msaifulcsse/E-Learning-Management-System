        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse navbar-responsive-collapse">
            ...
            <form class="navbar-form pull-left" action="courseSearch.php" method="post">
              <input type="text" class="form-control" name="searchInput" placeholder="Search this site..." id="searchInput">
...
<div class="container">
    <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
            <br><br>
               <h2 align="center">All Course || Web Development</h2>
               <hr>
            </div>
            <hr>
            <div class="col-sm-12">
      ...
      <center>
                    <?php                                                    
                        $sql = "SELECT * FROM `publish_course` where subsub_category ='Web Development'";
