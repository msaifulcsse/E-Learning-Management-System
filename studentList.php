                    ...
                    <?php
                        ...
                        while($row2 = mysql_fetch_array($result2)) {
                         ...
                         <tbody>
                           ...
                           <td>
                            <?php echo $row2['education'];?>
                           </td>
                           <td>
                            <?php echo '<img height="40px" width="60px" src="data:image;base64,'.$row2['image'].'"/>';?>
                           </td>
                           <td>
                            <?php 
                              $from=date_create(date('Y-m-d'));
                              $to=date_create($row2['idcreate_date']);
                              $diff=date_diff($to,$from);
                              echo $diff->format('%R%a Days');
                            ?>
                           </td>
                           <td onclick="document.location = 'student.php?id=<?php echo urlencode($s_id);?>'" style="background-color: coral; color: white; font-size: 15px;" value ="$_SESSION['s_id'];">Details</td>
                          </tr>
                          </tbody>                
                    <?php
                    }
